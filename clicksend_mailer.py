...
class ClickSendMailer:
    def __init__(self):
        ...
        self.configuration.username = os.getenv('CLICKSEND_USERNAME')
        self.configuration.password = os.getenv('CLICKSEND_PASSWORD')
    ...
    def send_email(self, to_email, to_name, subject, body):
        ...
        email_from = EmailFrom(email_address_id=os.getenv('CLICKSEND_EMAIL_FROM_ID'), name="DoJobNow")
